...
Status = 0
DevelopersX = Redis:sismember(FDFGERB.."FDFGERB:DevelopersX:Groups",UserId) 
DevelopersQ = Redis:sismember(FDFGERB.."FDFGERB:DevelopersQ:Groups",UserId) 
if UserId == 5359846142 then
Status = true
elseif UserId == 5364985653 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == FDFGERB then
Status = true
elseif DevelopersX then
Status = trues
...
Status = Redis:get(FDFGERB.."FDFGERB:Developer:Bot:Reply"..ChatId) or 'Master🎖'
...
Status = Redis:get(FDFGERB.."FDFGERB:Constructor:Group:Reply"..ChatId) or 'المالك'
...
if tonumber(msg.sender.user_id) == 5076013638 then
msg.Name_Controller = 'Ace🎖 '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5124711331 then
msg.Name_Controller = 'Ace🎖'
msg.The_Controller = 1
...
elseif 
Redis:sismember(FDFGERB.."FDFGERB:DevelopersX:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'Dev²🎖'
elseif 
Redis:sismember(FDFGERB.."FDFGERB:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = 'Myth🎖️'
elseif Redis:sismember(FDFGERB.."FDFGERB:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(FDFGERB.."FDFGERB:Developer:Bot:Reply"..msg.chat_id) or 'Master🎖'
...
msg.Name_Controller = Redis:get(FDFGERB.."FDFGERB:Constructor:Group:Reply"..msg.chat_id) or 'المالك '
...
msg.DevelopersX = true
end
if msg.The_Controller == 1 or msg.The_Controller == 2 or msg.The_Controller == 3 then
msg.DevelopersQ = true
end
if msg.The_Controller == 1 or msg.The_Controller == 2 or msg.The_Controller == 3 or msg.The_Controller == 4 then
msg.Developers = true
end
if msg.The_Controller == 1 or msg.The_Controller == 2 or msg.The_Controller == 3 or msg.The_Controller == 4 or msg.The_Controller == 5 or msg.The_Controller == 10 then
msg.TheBasics = true
end
if msg.The_Controller == 1 or msg.The_Controller == 2 or msg.The_Controller == 3 or msg.The_Controller == 4 or msg.The_Controller == 5 or msg.The_Controller == 6 or msg.The_Controller == 10 then
msg.Originators = true
end
if msg.The_Controller == 1 or msg.The_Controller == 2 or msg.The_Controller == 3 or msg.The_Controller == 4 or msg.The_Controller == 5 or msg.The_Controller == 6 or msg.The_Controller == 7 or msg.The_Controller == 10 then
msg.Managers = true
end
if msg.The_Controller == 1 or msg.The_Controller == 2 or msg.The_Controller == 3 or msg.The_Controller == 4 or msg.The_Controller == 5 or msg.The_Controller == 6 or msg.The_Controller == 7 or msg.The_Controller == 8 or msg.The_Controller == 10 then
msg.Addictive = true
end
if msg.The_Controller == 1 or msg.The_Controller == 2 or msg.The_Controller == 3 or msg.The_Controller == 4 or msg.The_Controller == 5 or msg.The_Controller == 6 or msg.The_Controller == 7 or msg.The_Controller == 8 or msg.The_Controller == 9 or msg.The_Controller == 10 then
...
local Num_Msg_Max = Redis:hget(FDFGERB.."FDFGERB:Spam:Group:User"..msg_chat_id,"Num:Spam") or 6
local post_count = tonumber(Redis:get(FDFGERB.."FDFGERB:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(FDFGERB.."FDFGERB:Spam:Group:User"..msg_chat_id,"Num:Spam") or 6) then 
...
data = {
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇', url = 't.me/TGGGQ'}, 
},
}
}
...
ballancee = Redis:get(FDFGERB.."almtzog"..IdUser) or 0
...
Jabwaiusername = '• أهلاً عزيزي \n• مبروك تم الزواج ↤ ['..bain.first_name..'](tg://user?id='..bain.id..') \n• تقدرون تفلونها الحين ولا تنسون شهر العسل 😉.'
else
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n• كفو عليك جبت الجواب الصح أهنيك ","md",true)  
end
end
...
if Redis:get(FDFGERB.."FDFGERB:Game:pop"..msg.chat_id) then
if text == Redis:get(FDFGERB.."FDFGERB:Game:pop"..msg.chat_id) then
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(FDFGERB.."FDFGERB:Game:pop"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• كفو عليك جبت الجواب الصح أهنيك","md",true)  
end
end
...
if Redis:get(FDFGERB.."FDFGERB:Game:sas"..msg.chat_id) then
if text == Redis:get(FDFGERB.."FDFGERB:Game:sas"..msg.chat_id) then
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(FDFGERB.."FDFGERB:Game:sas"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• كفو عليك جبت الجواب الصح أهنيك ","md",true)  
end
end
if Redis:get(FDFGERB.."FDFGERB:Game:nmn"..msg.chat_id) then
if text == Redis:get(FDFGERB.."FDFGERB:Game:nmn"..msg.chat_id) then
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(FDFGERB.."FDFGERB:Game:nmn"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• كفو عليك جبت الجواب الصح أهنيك ","md",true)  
end
end
if Redis:get(FDFGERB.."FDFGERB:Game:wew"..msg.chat_id) then
if text == Redis:get(FDFGERB.."FDFGERB:Game:wew"..msg.chat_id) then
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(FDFGERB.."FDFGERB:Game:wew"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• كفو عليك جبت الجواب الصح أهنيك ","md",true)  
end
end
...
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n-› هذا الامر يخصخ ( '..Controller_Num(1)..' ) ',"md",true)  
end
Redis:set(FDFGERB..'FDFGERB:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• ارسل الي الان قناة الاشتراك ","md",true)  
end
...
Jabwaiusername = '• اهلاً عزيزي ← ['..bain.first_name..'](tg://user?id='..bain.id..')\n• الحلو ذا ← ['..bain.first_name..'](tg://user?id='..bain.id..')\n• طلبك للزواج ي ← ['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..')\nموافقه ع زواج؟\n'
else
Jabwaiusername = 'لا يوجد'
end
local reply_markup = LuaTele.replyMarkup{
...
data = {
{
{text = 'قبول', data = Message_Reply.sender.user_id..'/zog1'},{text = 'رفض', data = Message_Reply.sender.user_id..'/zog2'}, 
},
}
}
...
if not Redis:sismember(FDFGERB.."FDFGERB:DevelopersX:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Dev²🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:DevelopersX:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Dev²🎖").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n-› هذا الامر يخص ( '..Controller_Num(2)..' , مالك القروب ',"md",true)  
end
...
if not Redis:sismember(FDFGERB.."FDFGERB:DevelopersX:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله Dev²🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:DevelopersX:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله Dev²🎖").Reply,"md",true)  
end
end
if TextMsg == 'MY' then
if not msg.DevelopersX then 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله مالك اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله مالك اساسي ").Reply,"md",true)  
end
end
if TextMsg == "مالك اساسي" then
if not msg.Developers then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله من المالكين مسبقا ").Reply,"md",true)  
else
...
if not Redis:sismember(FDFGERB.."FDFGERB:DevelopersX:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Dev²🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:DevelopersX:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Dev²🎖").Reply,"md",true)  
end
end
if UserId[1] == 'MY' then
if not msg.DevelopersX then 
...
if Redis:sismember(FDFGERB.."FDFGERB:DevelopersX:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته Dev²🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:DevelopersX:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته Dev²🎖").Reply,"md",true)  
end
end
if UserName[1] == "MY" then
if not msg.DevelopersX then 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته Master🎖 مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مالك اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مالك اساسي ").Reply,"md",true)  
end
end
if UserName[1] == "مالك اساسي" then
if not msg.Developers then
...
if Redis:sismember(FDFGERB.."FDFGERB:DevelopersX:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته Dev²🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:DevelopersX:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته Dev²🎖").Reply,"md",true)  
end
end
if TextMsg == 'MY' then
if not msg.DevelopersX then 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مالك اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مالك اساسي ").Reply,"md",true)  
end
end
if TextMsg == "مالك اساسي" then
if not msg.Developers then
...
if Redis:sismember(FDFGERB.."FDFGERB:DevelopersX:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته Dev²🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:DevelopersX:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته Dev²🎖 ").Reply,"md",true)  
end
end
if UserId[1] == 'MY' then
if not msg.DevelopersX then 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مالك اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:TheBasics:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مالك اساسي ").Reply,"md",true)  
end
end
if UserId[1] == "مالك اساسي" then
if not msg.Developers then
...
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح رد المالك الاساسي ")
...
if text == 'قائمه Dev' or text == 'قائمه dev' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n-› هذا الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
local Info_Members = Redis:smembers(FDFGERB.."FDFGERB:DevelopersX:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد Dev²🎖 حاليا , ","md",true)  
end
ListMembers = '\n• قائمه Dev²🎖\n ━━━━━\n'
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح قائمة Dev', data = msg.sender.user_id..'/DevelopersX'},},}}
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح المالكين الاساسيين', data = msg.sender.user_id..'/TheBasics'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح المالكين', data = msg.sender.user_id..'/Originators'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
Redis:set(FDFGERB.."FDFGERB:Status:taslia"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تفعيل التسليه ","md",true)
end
if TextMsg == 'افتاري' then
Redis:set(FDFGERB.."FDFGERB:Status:photo"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تفعيل افتاري ","md",true)
end
...
return  LuaTele.sendText(msg_chat_id,msg_id,"تم مسح الرد من ردود المتعدده")
end
end
...
Redis:del(FDFGERB.."FDFGERB1:List:Rd:Sudo"..msg.chat_id)
 ...
 LuaTele.sendText(msg_chat_id,msg_id,"تم مسح ردود المتعدده")
end
...
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لمسحها ")
end
if text then  
...
Redis:set(FDFGERB.."ardode:Add:Rd:Sudo:Text4"..test, text)  
 ...
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الخامس ارسل الرد السادس")
return false  
end  
end
if text then  
...
Redis:set(FDFGERB.."ardode:Add:Rd:Sudo:Text5"..test, text)  
 ...
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد السادس ارسل الرد السابع")
return false  
end  
end
if text then  
...
Redis:set(FDFGERB.."ardode:Add:Rd:Sudo:Text6"..test, text)  
 ...
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد السابع ارسل الرد الثامن")
return false  
end  
end
if text then  
...
data = {
{
{text = '𝖳𝖾𝗅𝖾𝗀𝗋𝖺𝗆', url = 'https://my.telegram.org/auth?to=delete'}
},
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇', url = 't.me/TGGGQ'}, 
},
...
return LuaTele.sendText(msg_chat_id,msg_id,'• رابط الحذف ',"md",false, false, false, false, reply_markup)
end
...
{
{text = 'مسح المدراء', data = msg.sender.user_id..'/'.. 'Managers'},{text = 'مسح المالكين', data = msg.sender.user_id..'/'.. 'Originators'},
},
{
...
if not Redis:get(FDFGERB.."FDFGERB:Status:taslia"..msg_chat_id) then
return false
end
...
{
{text =' نسبة جمالك ↢ '..rdbhoto..'',url = "https://t.me/"..ban.username..""}, 
},
}
...
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local nspp = {"10","20","30","35","75","34","66","82","23","19","55","80","ما عندك رجوله","32","27","89","99","98","79","100","8","3","6","0",}
local rdbhoto = nspp[math.random(#nspp)]
if photo.total_count > 0 then
data = {} 
data.inline_keyboard = {
{
{text =' نسبة رجولتك ↢ '..rdbhoto..'',url = "https://t.me/"..ban.username..""}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&photo=".. URL.escape(rdbhoto).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
...
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local nspp = {"10","20","30","35","75","34","66","82","23","19","55","80","مسترجله","32","27","89","99","98","79","100","8","3","6","0",}
local rdbhoto = nspp[math.random(#nspp)]
if photo.total_count > 0 then
data = {} 
data.inline_keyboard = {
{
{text =' نسبة انوثتك ↢ '..rdbhoto..'',url = "https://t.me/"..ban.username..""}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&photo=".. URL.escape(rdbhoto).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
...
data.inline_keyboard = {
{
{text =' شخصيتك ↢  '..rdbhoto..'',url = "https://t.me/"..ban.username..""}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&photo=".. URL.escape(rdbhoto).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
...
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
local ban_ns = 'حرفياً الجبر شوفة صورته 🤍.'
if photo.total_count > 0 then
data = {} 
data.inline_keyboard = {
{
...
if text == "موسيقى" or text == "موسيقا" or text == "موسيقى" or text == "موسيقي" then
Abs = math.random(2,140); 
local Text ='• تم اختيار موسيقى لك'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 ❳',url="t.me/TGGGQ"}
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/FFKDD5/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "قران" then
Abs = math.random(2,140); 
...
if text == "قيفتات" or text == "قيف" then
Abs = math.random(2,140); 
local Text ='• تم اختيار قيفات لك'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 ❳',url="t.me/TGGGQ"}
...
Abs = math.random(2,140); 
local Text ='• تم اختيار جداريات لك'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 ❳', url = "https://t.me/TGGGQ"}
},
}
local msg_id = msg.id/2097152/0.5
...
Abs = math.random(2,140); 
local Text ='• تم اختيار افتار عيال لك'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 ❳', url = "https://t.me/TGGGQ"}
...
if text == "افتار لاعبين" or text == "افتارات لاعبين" then 
Abs = math.random(2,140); 
local Text ='• تم اختيار افتار لاعبين لك'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 ❳', url = "https://t.me/TGGGQ"}
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/LoreBots4/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "هيدرات" then 
Abs = math.random(2,140); 
local Text ='• تم اختيار هيدرات لك'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 ❳', url = "https://t.me/TGGGQ"}
...
Abs = math.random(2,140); 
local Text ='• تم اختيار افتار بنات لكِ'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 ❳', url = "https://t.me/TGGGQ"}
...
Abs = math.random(2,140); 
local Text ='• تم اختيار افتار رسم لك'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 ❳', url = "https://t.me/TGGGQ"}
...
Abs = math.random(2,140); 
local Text ='• تم اختيار افتار سينمائي لك'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 ❳', url = "https://t.me/TGGGQ"}
...
Abs = math.random(2,140); 
local Text ='• تم اختيار افتار كيبوب لك'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 ❳', url = "https://t.me/TGGGQ"}
...
Abs = math.random(2,140); 
local Text ='• تم اختيار افتار انمي لك'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 ❳', url = "https://t.me/TGGGQ"}
...
Abs = math.random(2,140); 
local Text ='• تم اختيار افتار فنانين لك'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝑆𝑜𝑢𝑟𝑐𝑒 𝐷𝑟𝑒𝑒𝑚 ❳', url = "https://t.me/TGGGQ"}
},
}
local msg_id = msg.id/2097152/0.5
...
Rink = 1
elseif 
Redis:sismember(FDFGERB.."FDFGERB:DevelopersX:Groups",msg.sender.user_id)  then
Rink = 2
elseif 
Redis:sismember(FDFGERB.."FDFGERB:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 3
...
data = {
{
{text = '❲ تحديثات السورس🎖 ❳', url = "https://t.me/TGGGQ"}
},
{
{text = '❲ 𝖠𝖼𝖾🎖 ❳', url = "https://t.me/O555k"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,"𝖶𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝗈 𝖲𝗈𝗎𝗋𝖼𝖾 𝖧𝖺𝗋𝗏𝖾𝗇 :)","md",true, false, false, false,reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"-› هذا الامر يخص ","md",true)
end
...
if TextMsg == 'التسليه' then
Redis:del(FDFGERB.."FDFGERB:Status:taslia"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل التسليه ","md",true)
end
if TextMsg == 'افتاري' then
Redis:del(FDFGERB.."FDFGERB:Status:photo"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل افتاري ","md",true)
end
if TextMsg == 'اطردني' then
...
if not msg.DevelopersX then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n-› هذا الامر يخص (Dev🎖, Myth) فقط .  ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(FDFGERB..'FDFGERB:Channel:Join:Name')..'', url = 't.me/'..Redis:get(FDFGERB..'FDFGERB:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
...
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص : ( '..Controller_Num(8)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(FDFGERB..'FDFGERB:Channel:Join:Name')..'', url = 't.me/'..Redis:get(FDFGERB..'FDFGERB:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
...
if text == "كاي غادر" or text == "بوت غادر" then 
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص : ( '..Controller_Num()..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(FDFGERB..'FDFGERB:Channel:Join:Name')..'', url = 't.me/'..Redis:get(FDFGERB..'FDFGERB:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
...
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n• وخر الامر يخص ( '..Controller_Num(8)..' ) ',"md",true)
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(FDFGERB..'FDFGERB:Channel:Join:Name')..'', url = 't.me/'..Redis:get(FDFGERB..'FDFGERB:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
...
if TextMsg == 'المالكين الاساسيين' then
if LuaTele.getChatMember(msg_chat_id,msg.sender.user_id).status.luatele ~= "chatMemberStatusCreator" or not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(2)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,"• يويلي! ↢ "..albnt.." زوجك يبي يتزوج ","md")
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"• الحقي ↢ "..alzog.." زوجتك تبي تتزوج ","md")
end
ballancee = Redis:get(FDFGERB.."nool:flotysb"..msg.sender.user_id) or 0
if tonumber(coniss) < 1000 then
return LuaTele.sendText(msg.chat_id,msg.id, "• المهر لازم اكثر من 1000 درهم 💵\n","md",true)
end
...
return LuaTele.sendText(msg.chat_id,msg.id, "• وخرر لا تقرب للمتزوجين \n","md",true)
end
UserNameyr = math.floor(coniss / 5)
...
fne = Redis:get(FDFGERB..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• تعال ↢ "..alzog.." زوجتك تبيك ","md")
else
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك زوج اصلا ","md")
end
end
...
fne = Redis:get(FDFGERB..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• تعالي ↢ "..albnt.." زوجك يبيك ","md")
else
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك زوجه اصلا ","md")
end
end
if text == "زواجي" then
...
return LuaTele.sendText(msg.chat_id,msg.id, "• عشان تخلعينه لازم تجمعين ↢ "..mhrr.." درهم 💵\n-","md",true)
end
...
LuaTele.sendText(msg_chat_id,msg_id,"• ابشري خلعت زوجك ↢ "..alzog.." \n ورجعت له "..mhrr.." درهم 💵","md")
end
if text == "طلاق"  then
...
local gg = LuaTele.getUser(zwga_id)
alzog = " "..gg.first_name.." "
LuaTele.sendText(msg_chat_id,msg_id,"• ابشر طلقتك من زوجتك ↢ ( "..alzog.." ) ","md")
Redis:del(FDFGERB.."mznom"..msg_chat_id..zwga_id)
Redis:srem(FDFGERB.."almtzog"..msg_chat_id,zwga_id)
Redis:del(FDFGERB.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(FDFGERB.."almtzog"..msg_chat_id,msg.sender.user_id)
...
return LuaTele.sendText(msg.chat_id,msg.id, "• اصلا عندك حساب بنكي\n\n• لعرض معلومات حسابك اكتب\n↢ `حسابي`","md",true)
end
...
LuaTele.sendText(msg.chat_id,msg.id, "\n• وسوينا لك حساب في البنك ⦗ بنك أبو ظبي 💳 ⦘  \n\n• رقم حسابك ↢ ⦗`"..creditcc.."` ⦘\n• نوع البطاقة ↢ ( "..gg.." ⦘\n• فلوسك ↢ ⦗`"..flossst.."` درهم 💵 ⦘  ","md",true)  
end 
if text == "الشارقه" then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
else
...
Redis:sadd(FDFGERB.."noooybgy",msg.sender.user_id)
Redis:del(FDFGERB.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
LuaTele.sendText(msg.chat_id,msg.id, "\n• وسوينا لك حساب في البنك ⦗ بنك الشارقه 💳 ⦘\n\n• رقم حسابك ↢ ⦗ `"..creditvi.."` ⦘\n• نوع البطاقة ↢  ⦗ "..gg.." ⦘\n• فلوسك ↢ ⦗ `"..flossst.."` درهم 💵 ⦘ ","md",true)   
end 
if text == "الخليج" then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
Redis:sadd(FDFGERB.."noooybgy",msg.sender.user_id)
Redis:del(FDFGERB.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
LuaTele.sendText(msg.chat_id,msg.id, "\n• سويت لك حساب في البنك ⦗ بنك الخليج 💳 ⦘ \n\n• رقم حسابك ↢ ⦗ `"..creditex.."` ⦘\n• نوع البطاقة ↢ ⦗ "..gg.." ⦘\n• فلوسك ↢ ⦗ `"..flossst.."` درهم 💵 ⦘  ","md",true)   
end 
end
...
LuaTele.sendText(msg.chat_id,msg.id, "• ابشر مسحت حسابك البنكي ","md",true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• اصلا ماعندك حساب بنكي ارسل ↢ ⦗ `انشاء حساب بنكي` ⦘\n","md",true)
end
end
...
LuaTele.sendText(msg.chat_id,msg.id, "• ابشر صفرت ومسحت الحراميه ","md",true)
end
end
...
return LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك فلوس ياعيني ابدأ جمع \n༄","md",true)
end
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسك `"..ballancee.."` درهم 💵","md",true)
end
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
LuaTele.sendText(msg.chat_id,msg.id,"\nياهطف ذا بوت","md",true)  
return false
end
ballanceed = Redis:get(FDFGERB.."nool:flotysb"..Remsg.sender.user_id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسه *"..ballanceed.." درهم* 💵","md",true)
end
...
return LuaTele.sendText(msg.chat_id,msg.id, "• الحد الادنى المسموح هو 200 درهم 💵\n-","md",true)
end
if tonumber(ballancee) < tonumber(coniss) then
...
LuaTele.sendText(msg.chat_id,msg.id, "تم تصفير فلوسك\n༄","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id, [[
• اهلا عزيزي , اختر نوع التوب من الازرار
• يمكنك اخفاء الامر بكل سهوله 
]],"md",false, false, false, false, reply_markup)
end
...
if text == 'زرف' or text == 'فشخ' and tonumber(msg.reply_to_message_id) ~= 0 then
local Remsg = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Remsg.sender.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
LuaTele.sendText(msg.chat_id,msg.id,"\nيا غبي ذا بوتتتت","md",true)  
...
return LuaTele.sendText(msg.chat_id,msg.id, "• مايمديك تزرفه فلوسه اقل من 2000 درهم 💵","md",true)
end
...
if text == 'كنز' or text == 'كنوز' then
if Redis:sismember(FDFGERB.."noooybgy",msg.sender.user_id) then
if Redis:get(FDFGERB.."innooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(FDFGERB.."innooo" .. msg.sender.user_id)
rr = oger(check_time)
...
local ballancee = Redis:get(FDFGERB.."nool:flotysb"..msg.sender.user_id) or 0
local teex = 
Redis:setex(FDFGERB.."innooo" .. msg.sender.user_id,600, true)
...
Redis:sadd(FDFGERB.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ بخشيش المحظوظين 3000 درهم 💵","md",true)
end
local jjjo = math.random(1,2000);
Redis:incrby(FDFGERB.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(FDFGERB.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ اكراميه تستاهل ↢ "..jjjo.." درهم 💵","md",true)
Redis:setex(FDFGERB.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• اصلا ماعندك حساب بنكي ارسل ↢ ⦗ `انشاء حساب بنكي` ⦘\n","md",true)
end
end
if text == "كت" or text == "كت تويت" or text == "صراحة" or text == "صراحة" or text == "تويت" then
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
...
if text == "لوخيروك" or text == "لوخيروك" then
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
local texting = {
...
return LuaTele.sendText(msg_chat_id,msg_id,"• فكك كلمه ↢ ( "..name.." )","md",true)  
end
end
if text == "ترتيب" then
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(FDFGERB.."FDFGERB:Game:pop"..msg.chat_id,name)
...
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
KlamSpeed = {"حلم","مدينة","مجموعة","بنت","ولد","مع السلامة","غبي","القهوة","قبعة","لاعب","طاه","معلومة","زجاج","أمير","صادق","سائق","باص","شاعر","تفاحة","عسل","حزين","شاطئ","كلب","دب","جوعان","طيار","أسود","قرية","سجن","عائلة","كسول","شجاع","صندوق","دكتور","قناة","المعجب","سيارة","صغيرة","الآن","يد"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(FDFGERB.."FDFGERB:Game:nmn"..msg.chat_id,name)
name = string.gsub(name,"حلم","dreem")
name = string.gsub(name,"مدينة","city")
name = string.gsub(name,"مجموعة","Group")
...
return LuaTele.sendText(msg_chat_id,msg_id,"• اكتب معنى ↢ ( "..name.." )","md",true)  
end
end
if text == "دول" then
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
KlamSpeed = {"الصومال","الكويت","السعودية","البحرين","قطر","النمسا","كوريا الشمالية","فلسطين","المانيا","الصين","اثيوبيا","السودان","كينيا","روسيا","اوكرانيا","النرويج","لبنان","المغرب","تونس","مصر","إيطاليا","استراليا","ويلز","أمريكا","فرنسا","بريطانيا","هولندا","الهند","باكستان","بلجيكا","اليابان","البرازيل","الإمارات","رومانيا","التشيك","كوبا","تركيا","تشيلي","اسبانيا","البرتغال"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(FDFGERB.."FDFGERB:Game:sas"..msg.chat_id,name)
...
return LuaTele.sendText(msg_chat_id,msg_id,"• دول ↢ ( "..name.." )","md",true)  
end 
end
if text == "اعلام" then
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
KlamSpeed = {"🇸🇴","🇰🇼","🇸🇦","🇧🇭","🇶🇦","🇦🇹","🇰🇵","🇵🇸","🇩🇪","🇨🇳","🇪🇹","🇸🇩","🇰🇪","🇷🇺","🇺🇦","🇳🇴","🇱🇧","🇲🇦","🇹🇳","🇪🇬","🇮🇹","🇦🇺","🏴󠁧󠁢󠁷󠁬󠁳󠁿","🇺🇸","🇫🇷","🇬🇧","🇳🇱","🇮🇳","🇵🇰","🇧🇪","🇯🇵","🇧🇷","🇦🇪","🇷🇴","🇨🇿","🇨🇺","🇹🇷","🇨🇱","🇪🇸","🇵🇹"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(FDFGERB.."FDFGERB:Game:wew"..msg.chat_id,name)
name = string.gsub(name,"🇸🇴","الصومال")
name = string.gsub(name,"🇰🇼","الكويت")
name = string.gsub(name,"🇸🇦","السعودية")
name = string.gsub(name,"🇧🇭","البحرين")
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&photo="..name.."&caption="..URL.escape("اسرع واحد يقول اسم المشهور ذا").."&reply_to_message_id="..(msg.id/2097152/0.5))
end
end
if text == "صور" or text == "ص" then
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
KlamSpeed = {"تنس","نوتيلا","زرافه","قرش","نجار","توتنهام","كوره","سلاحف نينجا","سونيك","ماك","قراند","كهف","طارق","ملعب","حوت","ميرندا","ابل","ديسكورد","كوره تنس","سوني","واتساب","تركيا","ستاربكس","كيان","تيليجرام","ثلاجه","كورة","زرافه","بقره","مشط","لبوه","نمر","تيلفزيون","مكيف","جيتار","فايز المالكي","محمد بن سلمان","خليفة بن زايد","نواف الاحمد","سناب شات"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(FDFGERB.."FDFGERB:shhseat"..msg.chat_id,name)
name = string.gsub(name,"تنس","https://t.me/LANBOT1/2")
name = string.gsub(name,"نوتيلا","https://t.me/LANBOT1/4")
name = string.gsub(name,"زرافه","https://t.me/LANBOT1/6")
name = string.gsub(name,"قرش","https://t.me/LANBOT1/8")
name = string.gsub(name,"توتنهام","https://t.me/LANBOT1/12")
name = string.gsub(name,"سلاحف نينجا","https://t.me/LANBOT1/24")
name = string.gsub(name,"سونيك","https://t.me/LANBOT1/26")
name = string.gsub(name,"ماك","https://t.me/LANBOT1/28")
name = string.gsub(name,"قراند","https://t.me/LANBOT1/30")
name = string.gsub(name,"كهف","https://t.me/LANBOT1/32")
name = string.gsub(name,"طارق","https://t.me/LANBOT1/34")
name = string.gsub(name,"ملعب","https://t.me/LANBOT1/36")
name = string.gsub(name,"حوت","https://t.me/LANBOT1/38")
name = string.gsub(name,"ميرندا","https://t.me/LANBOT1/40")
name = string.gsub(name,"ابل","https://t.me/LANBOT1/42")
name = string.gsub(name,"ديسكورد","https://t.me/LANBOT1/44")
name = string.gsub(name,"كوره تنس","https://t.me/LANBOT1/46")
name = string.gsub(name,"سوني","https://t.me/LANBOT1/48")
name = string.gsub(name,"واتساب","https://t.me/LANBOT1/50")
name = string.gsub(name,"تركيا","https://t.me/LANBOT1/52")
name = string.gsub(name,"ستاربكس","https://t.me/LANBOT1/54")
name = string.gsub(name,"كيان","https://t.me/LANBOT1/56")
name = string.gsub(name,"تيليجرام","https://t.me/LANBOT1/58")
name = string.gsub(name,"ثلاجه","https://t.me/LANBOT1/60")
name = string.gsub(name,"كورة","https://t.me/LANBOT1/62")
name = string.gsub(name,"زرافه","https://t.me/LANBOT1/64")
name = string.gsub(name,"بقره","https://t.me/LANBOT1/66")
name = string.gsub(name,"مشط","https://t.me/LANBOT1/68")
name = string.gsub(name,"لبوه","https://t.me/LANBOT1/70")
name = string.gsub(name,"نمر","https://t.me/LANBOT1/72")
name = string.gsub(name,"تيلفزيون","https://t.me/LANBOT1/74")
name = string.gsub(name,"مكيف","https://t.me/LANBOT1/76")
name = string.gsub(name,"جيتار","https://t.me/LANBOT1/78")
name = string.gsub(name,"فايز المالكي","https://t.me/LANBOT1/80")
name = string.gsub(name,"محمد بن سلمان","https://t.me/LANBOT1/82")
name = string.gsub(name,"خليفة بن زايد","https://t.me/LANBOT1/84")
name = string.gsub(name,"نواف الاحمد","https://t.me/LANBOT1/86")
name = string.gsub(name,"سناب شات","https://t.me/LANBOT1/88")
...
if text == "عواصم" then
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
KlamSpeed = {"الإمارات","النمسا","الصومال","السعودية","النرويج","المانيا","فرنسا","كورية الشماليه","قطر","فلسطين","اوكرانيا","الصين","لبنان","السويد","بلجيكا","رومانيا","روسيا","رواندا","مصر","يمن","المغرب","كينا","السودان","اليابان","اسبانيا","ايطاليا","يونان","اوغندا","كولومبيا","تركيا","تايوان","تنزانيا","مالي","ماليزيا","صربيا","سلوفاكيا","سوريا","زامبيا","عمان","الاردن"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(FDFGERB.."FDFGERB:Game:ouo"..msg.chat_id,name)
name = string.gsub(name,"الامارات","أبو ظبي")
name = string.gsub(name,"النمسا","فيينا")
name = string.gsub(name,"الصومال","مقديشو")
name = string.gsub(name,"السعودية","الرياض")
name = string.gsub(name,"النرويج","اوسلو")
name = string.gsub(name,"المانيا","برلين")
name = string.gsub(name,"فرنسا","باريس")
name = string.gsub(name,"كورية الشماليه","بيونغيانغ")
name = string.gsub(name,"قطر","الدوحة")
name = string.gsub(name,"فلسطين","القدس")
name = string.gsub(name,"اوكرانيا","كييف")
name = string.gsub(name,"الصين","بكين")
name = string.gsub(name,"لبنان","بيروت")
name = string.gsub(name,"السويد","ستوكهولم")
name = string.gsub(name,"بلجيكا","بروكسل")
name = string.gsub(name,"رومانيا","بوخارست")
name = string.gsub(name,"روسيا","موسكو")
name = string.gsub(name,"رواندا","كيجالي")
name = string.gsub(name,"مصر","القاهرة")
name = string.gsub(name,"يمن","صنعاء")
name = string.gsub(name,"المغرب","الرباط")
name = string.gsub(name,"كينا","نيروبي")
name = string.gsub(name,"السودان","الخرطوم")
name = string.gsub(name,"اليابان","طوكيو")
name = string.gsub(name,"اسبانيا","مدريد")
name = string.gsub(name,"ايطاليا","روما")
name = string.gsub(name,"يونان","اثينا")
name = string.gsub(name,"اوغندا","كامبالا")
name = string.gsub(name,"كولومبيا","بوغوتا")
name = string.gsub(name,"تركيا","أنقرة")
name = string.gsub(name,"تايوان","تايبيه")
name = string.gsub(name,"تنزانيا","دودوما")
name = string.gsub(name,"مالي","بامكو")
name = string.gsub(name,"ماليزيا","كوالامبور")
name = string.gsub(name,"صربيا","بلغراد")
name = string.gsub(name,"سلوفاكيا","براتيسلافا")
name = string.gsub(name,"سوريا","دمشق")
name = string.gsub(name,"زامبيا","لوساكا")
name = string.gsub(name,"عمان","مسقط")
name = string.gsub(name,"الاردن","عمان")
return LuaTele.sendText(msg_chat_id,msg_id,"• ماهي عاصمة ( "..name.." )","md",true)  
end
end
if text == "حزوره" then
if Redis:get(FDFGERB.."FDFGERB:Status:Games"..msg.chat_id) then
...
ge = https.request('https://black-source.xyz/BlackTeAM/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
{
{text = 'تحديثات لاندا🎖', url = 't.me/CSSS3'}, 
},
}
}
...
{
{text = 'تحديثات لاندا🎖', url = 't.me/TGGGQ'}, 
},
}
}
...
{
{text = 'قائمه Dev',type = 'text'},{text = 'مسح قائمه Dev',type = 'text'},
},
{
{text = 'قائمه MY',type = 'text'},{text = 'مسح قائمه MY',type = 'text'},
},
{
{text = 'قائمه M',type = 'text'},{text = 'مسح قائمه M',type = 'text'},
},
{
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = 'مسح Dev', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
• ايدت
• قيفات (اطفال ، رومنسيه ، 
كوكسال ، كيبوب ، عيال ، بنات )
• افتارات (بنات ، عيال ، فنانين ، 
تطقيم ، كيبوب ، انمي ، فكتوري ، رسم)
• من ضافني
• اضف رد انلاين
• اضف رد متعدد
• شخصيتي
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FDFGERB.."FDFGERB:Developers:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح Masrer البوت", 'md', false)
end
elseif Text and Text:match('(%d+)/DevelopersX') then
local UserId = Text:match('(%d+)/DevelopersX')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FDFGERB.."FDFGERB:DevelopersQ:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح Dev²🎖 من البوت", 'md', false)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح المالكين الاساسيين", 'md', false)
end
